    ...
    return (
        <Canvas>
            ...
            <Container style={{ flex: 1 }}>
                <InfoWrapper>
                    <InfoBody>
                        <Image source={notificationIcon} style={{ marginBottom: 12, width: 40, height: 40 }} resizeMode='contain'/>
                        <Text fontSize='h2' fontWeight='bold'>Turn on reminders to meditate</Text>
                        <Text fontSize='md' style={{ marginTop: 5 }}>Set yourself up for success.</Text>
                    </InfoBody>
                    <InfoFooter>
