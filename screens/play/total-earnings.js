...
export default function TotalEarnings({ route, navigation }) {
    ...
    const ZentBanner = <ZentTokenBanner tokens={20.13} usd={0} />;
        ...
        <Canvas>
            <Container style={{ flex: 1 }}>
                <Animated.ScrollView style={{ width: '100%' }}
                    ...
                    <Text fontSize="20" fontWeight='600' style={{ marginTop: 20, marginBottom: 10, width: '100%', textAlign: 'center' }}>You’ve earned the maximum today</Text>
                    <Text fontSize="lg" style={{ marginBottom: 20, width: '100%', textAlign: 'center' }}>3 hour earning limit</Text>
                    ...
                    <WalletHistoryList>
                        <WalletHistoryListText>
                            <Text fontSize='lg' numberOfLines={1} color='primary'>10 minutes • 0.02 ZENT</Text>
                            <Text fontSize='md' numberOfLines={1} style={{ marginTop: 2 }}>Move Mountain</Text>
                    ...
                    <WalletHistoryList>
                        <WalletHistoryListText>
                            <Text fontSize='lg' numberOfLines={1} color='primary'>5 minutes • 0.01 ZENT</Text>
                            <Text fontSize='md' numberOfLines={1} style={{ marginTop: 2 }} >Let Go</Text>
                    ...
                    <WalletHistoryList>
                        <WalletHistoryListText>
                            <Text fontSize='lg' numberOfLines={1} color='primary'>15 minutes • 0.03 ZENT</Text>
                            <Text fontSize='md' numberOfLines={1} style={{ marginTop: 2 }}>Wisdom of The Ancients</Text>
            ...
            <BlurView style={{
                ...
                <Button title='Done' block variant='primary' />
            </BlurView>
        </Canvas>
    );
}
