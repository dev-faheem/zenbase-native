        ...
        <BackgroundWrapper source={ZentBackground}>
            <CardWrapper>
                <CardBody>
                    ...
                    <Text fontSize='xl' fontWeight='500' style={{ marginTop: 20, textAlign: 'center' }} color='header90'>Today is a beautiful day to take care </Text>
                    <Text fontSize='xl' fontWeight='500' style={{ marginTop: 5, textAlign: 'center' }} color='header90'>of yourself.</Text>
                </CardBody>
                <CardFooterMargin />
            </CardWrapper>
        </BackgroundWrapper>
