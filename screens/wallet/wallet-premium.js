                ...
                <FooterWrapper>
                    <Container style={{ flex: 1 }}>
                        <FooterFlex>
                            ...
                            <Button style={{ marginTop: 5, marginBottom: 5 }} title='Continue ($3.99 per month)' block onPress={() => { }} />
                            <Button style={{ marginTop: 3, marginBottom: 3 }} title='Redeem 1 month (42 ZENT)' variant={isRedeemButtonEnabled ? 'secondary': 'disabled'} block onPress={() => { 
