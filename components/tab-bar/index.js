...
export default function TabBar({ state, descriptors, navigation }) {
    ...
    return <BlurView intensity={200} tint="dark" style={{ position: 'absolute', width: '100%', bottom: 0, left: 0, height: useSafeAreaInsets().bottom + 50, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        <TabBarWrapper>
                ...
                return (
                    ...
                    >
                        {(() => {
                            switch (label) {
                                case 'Home':
                                    return <Ionicons name='play-circle' size={28} color={isFocused ? theme.color.primary : theme.color.secondary} />
                                case 'Search':
