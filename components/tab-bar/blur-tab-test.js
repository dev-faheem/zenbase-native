...
export default function TabBar({ state, descriptors, navigation }) {
    ...
    return <BlurView intensity={100} tint="dark" style={{ position: 'absolute', width: '100%', bottom: 0, left: 0, height: 90, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
        <TabBarWrapper>
